...
def main() -> int:
    return run_archive_main(
        IMPL_PATH,
        "_archive_run_gold_eval",
        wrapper_name="run_gold_eval",
        missing_dependency_note="this archived script requires additional legacy modules that may not be installed.",
    )
